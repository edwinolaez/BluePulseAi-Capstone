      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-cyan-500/15 border border-cyan-500/30 mb-4">
            <svg viewBox="0 0 24 24" className="w-7 h-7 stroke-cyan-400 fill-none" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="9" />
              <path d="M12 2v4M12 18v4M2 12h4M18 12h4" />
              <circle cx="12" cy="12" r="2" />
            </svg>
          </div>
          <h1 className="text-xl font-bold text-white mb-1">Jasper Environmental Twin</h1>
          <p className="text-sm text-gray-400">Sign in to access the monitoring dashboard</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                className="w-full px-4 py-2.5 rounded-lg bg-gray-800 border border-gray-700 text-gray-100 placeholder:text-gray-600 text-sm outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 pr-11 rounded-lg bg-gray-800 border border-gray-700 text-gray-100 placeholder:text-gray-600 text-sm outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors"
                />
                <button
                  type="button"
        ...
        <details className="mt-4 text-center">
          <summary className="text-xs text-gray-700 cursor-pointer hover:text-gray-500 transition-colors">
            Demo credentials ▸
          </summary>
          <div className="mt-2 text-[11px] text-gray-600 space-y-1 font-mono">
            <p>eleanor@jasper.ca / Research@2024 (Researcher)</p>
            <p>edwin@jasper.ca / Admin@2024 (Admin)</p>
            <p>admin@jasper.ca / Super@2024 (Superadmin)</p>
          </div>
        </details>
      </div>
    </div>
