...
export function Footer({ currentUser }: Props) {
  return (
    <footer className="h-9 shrink-0 flex items-center justify-between px-6 bg-surface border-t border-gray-200/60 dark:border-gray-800/60 text-[11px] text-gray-600 dark:text-gray-400">
