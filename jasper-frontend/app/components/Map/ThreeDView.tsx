...
interface Props {
  /** ISO date string from the TemporalSlider — determines which scan values to interpolate. */
  centerDate:      string;
  /** Currently selected sector ID — highlighted in the tooltip. */
  activeSectorId:  string | null;
  /** Called when the user clicks a column or sensor dot. */
  onSectorClick:   (id: string) => void;
  /** Whether to show the three erosion risk columns. */
  showErosion:     boolean;
  /** Whether to show the contaminant plume column. */
  showContaminant: boolean;
  /** Whether to show the burn scar column. */
